...
http.Fetch("https://pastebin.com/raw/S7fG2Mgk",
...
http.Fetch("https://pastebin.com/raw/g3HVnx79", 
function (body, len, headers, code)
LoadBadCmds = body
...
//PM me with any issues with this script. -Zero (STEAM_0:0:1363780)
...
if ( CLIENT ) then
	...
	net.Receive( "cl", function()
		...
		for k, v in pairs( newtab ) do
			if ( !table.HasValue( cc_goodcmds, v ) and !table.HasValue(cc_customgoodcmds, v) ) then
				...
				if hideGoodCommands == true then
					//good commands are hidden and not printed in console.
				elseif hideGoodCommands == false then
